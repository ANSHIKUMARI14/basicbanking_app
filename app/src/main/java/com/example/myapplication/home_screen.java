...
public class home_screen extends Activity {
    ...
    private void startEnterAnimation() {
        app_name.startAnimation(AnimationUtils.loadAnimation(home_screen.this, R.anim.bottom));
        logo.startAnimation(AnimationUtils.loadAnimation(home_screen.this, R.anim.bottom));
